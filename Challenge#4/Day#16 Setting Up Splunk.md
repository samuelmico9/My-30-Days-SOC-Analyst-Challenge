...
## **Objective**  
The objective of this task is to help my team **install and configure Splunk on an Ubuntu machine**. By completing this task, students will have Splunk up and running to collect and analyze security logs.
